...
use sonnet composer 2.5 as scouts to look at files, folder etc and do the actual implementation. You should orchestrate, do the hard thinking, the designing and the planning. 
